            ...
            <form name="memberForm" class=memberForm" action="javascript:send();" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <c:if test="${dto.userId != 'admin'}">
                        ...
                        <img class="userImg user1" id="user1" value="user1" src="<%=cp%>/resource/img/user1.png" alt="user1"/>
                        <img class="userImg user2" id="user2" value="user2" src="<%=cp%>/resource/img/user2.png" alt="user2"/>
                        <img class="userImg user3" id="user3" value="user3" src="<%=cp%>/resource/img/user3.png" alt="user3"/>
                        <img class="userImg user4" id="user4" value="user4" src="<%=cp%>/resource/img/user4.png" alt="user4"/>
                        <img class="userImg user5" id="user5" value="user5" src="<%=cp%>/resource/img/user5.png" alt="user5"/>
                    </c:if>
                </div>
                <div>
