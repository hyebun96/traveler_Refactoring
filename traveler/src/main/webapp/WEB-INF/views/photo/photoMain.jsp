...
<div class="photoselect">
    ...
    <table class="photomainuser" style="text-align: center; width: 6%; height: 610px; float: left;">
        <tr align="left" class="photomember">
            <td>
                <button type="button" value="nam" style="width: 100%; "
                        onclick="javascript:location.href='<%=cp%>/photo/photoMain.do'" class="btn1"> ALL
                </button>
            </td>
        </tr>
        <tr height="20px;"></tr>
        ...
        <tr align="left" class="photomember">
            <td>
                <button type="button" value="nam" style="width: 100%;"
                        onclick="javascript:location.href='<%=cp%>/photo/photoMain.do?nam=nam'" class="btn1"> 남상현
                </button>
            </td>
        </tr>
        <tr height="20px;"></tr>
        <tr align="left" class="photomember">
            <td>
                <button type="button" value="nam" style="width: 100%;"
                        onclick="javascript:location.href='<%=cp%>/photo/photoMain.do?nam=kim'" class="btn1"> 김종완
                </button>
            </td>
        </tr>
        <tr height="20px;"></tr>
        <tr align="left" class="photomember">
            <td>
                <button type="button" value="nam" style="width: 100%;"
                        onclick="javascript:location.href='<%=cp%>/photo/photoMain.do?nam=lee'" class="btn1"> 이다혜
                </button>
            </td>
        </tr>
        <tr height="20px;"></tr>
        <tr align="left" class="photomember">
            <td>
                <button type="button" value="nam" style="width: 100%;"
                        onclick="javascript:location.href='<%=cp%>/photo/photoMain.do?nam=jun'" class="btn1"> 전미주
                </button>
            </td>
        </tr>
        <tr height="20px;"></tr>
        <tr align="left" class="photomember">
            <td>
                <button type="button" value="nam" style="width: 100%;"
                        onclick="javascript:location.href='<%=cp%>/photo/photoMain.do?nam=jung'" class="btn1"> 정혜분
                </button>
            </td>
        </tr>
        ...
        <tr height="30">
            <td align="center">
                <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/photo/created.do';"
                        style="width: 100%">Photo_Upload
                </button>
            </td>
        </tr>
    </table>
