...
<head>
    ...
    <link rel="stylesheet" href="<%=cp%>/resources/css/photo.css" type="text/css">
    ...
    <div class="photo">
        ...
        <div class="post-move">
            <div class="photo-menu">
                ...
                <c:forEach var="allDTO" items="${allList}">
                    <img id="photo-${allDTO.photoNum}" onclick="ListPhoto('${allDTO.photoNum}')" alt="" src="<%=cp%>/uploads/photo/${allDTO.saveFilename}">
                </c:forEach>
            </div>
        </div>
        ...
        <table class="photo-list">
            <tr class="post-move">
                ...
                <td class="center-img">
                    <img id="photo-img" src="<%=cp%>/uploads/photo/${dto.saveFilename}">
                </td>
                <td class="move">
                    <span class="next">
            ...
            <tr class="tag-tr">
                ...
                <td class="center-img">
                    ...
                    <marquee class="tag-list" behavior="slide" scrollamount="8">
            ...
            <tr>
                ...
                <td class="center-img">
                    <div class="photo-box2">
                        <img src="<%=cp%>/resources/img/user.png" alt="">
