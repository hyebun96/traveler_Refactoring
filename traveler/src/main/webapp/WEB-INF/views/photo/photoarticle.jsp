...
<div class="photoarticle1">
    <div class="photoarticle2" style="width: 700px; margin: 100px 10px 10px 600px;">
        <font color="458B74" face="궁서체" size="16px" style="margin: 30px auto; text-align: center;"><i> Photo
            Content </i></font>
            ...
            <tr>
                <td colspan="2" align="left" style="padding: 10px 5px; margin: 50px auto;">
                    <img src="<%=cp%>/uploads/photo/${dto.imageFilename}"
                         style="max-width:100%; height:300px; resize:both;">
                </td>
            </tr>

            <tr style="border-bottom: 1px solid #4CAF50;" height="40">
                <td colspan="2" align="left" style="padding: 0px 5px 20px; font-size: 16px; margin: 50px auto;"
                    height="40">
                    ${dto.content}
                </td>
            </tr>
            ...
            <tr height="45">
                ...
                <td align="right">
                    <button type="button" class="btn1"
                            onclick="javascript:location.href='<%=cp%>/photo/photoMain.do?page=${page}';">List
                    </button>
                </td>
            </tr>
        </table>
