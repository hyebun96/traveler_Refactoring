        ...
        <form class="writeBoardForm" name="photoForm" method="post" enctype="multipart/form-data">
            <div class="travel-box">
                ...
                <p>&nbsp;작성자 </p>
                    ...
                    <img src="<%=cp%>/resource/img/${sessionScope.member.imageFilename}.png" alt="" >
                <br>
                <p>장&nbsp;&nbsp;&nbsp;소 </p>
                ...
                <c:if test="${dto.imageFilename == null}">
                    ...
                    <input type="file" name="upload" value="${dto.imageFilename}">
                    <br>
                </c:if>
                <c:if test="${dto.imageFilename != null}">
                    <p>첨부된 파일</p>
                    <div class="imageList">
                            ${dto.imageFilename} &nbsp;&nbsp;|&nbsp;&nbsp; <a onclick="deleteFile('${mode}', '${dto.photoNum}');">삭제</a><br>
                    </div>
                </c:if>
            </div>
