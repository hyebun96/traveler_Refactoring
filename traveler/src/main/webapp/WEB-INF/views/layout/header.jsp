...
<script type="text/javascript" src="<%=cp%>/resources/js/header.js"></script>

<div class="header-top">
    <div class="header-left">
        <p>
            <a href="<%=cp%>/main/main.do">
                <img id="logo" alt="HOME" src="<%=cp%>/resources/img/logo3.png">
            </a>
        </p>
    </div>
                ...
                <li class="nav-li2" >
                    ...
                    <c:if test="${not empty sessionScope.member}">
                        ...
                        <a href="<%=cp%>/member/myPage.do?mode=update">
                            <img id="profile" src='<%=cp%>/resources/img/${sessionScope.member.userId != null ?  sessionScope.member.imageFilename :  "user1"}.png' />
                        </a>
                    </c:if>
                </li>
            </ul>
