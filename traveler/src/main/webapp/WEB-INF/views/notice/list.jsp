...
<div class="board">
    ...
    <form name="searchForm" action="<%=cp%>/notice/notice.do" method="post">
        <div>
            ...
            <button class="board-button" type="button" onclick="searchList()">검색</button>
            <button class="board-button" type="button" onclick="javascript:location.href='<%=cp%>/notice/notice.do';">새로고침</button>
        </div>
    </form>
    ...
    <table class="board-table">
        <tr>
            ...
            <tr height="35" class="board-created">
                <td colspan="5">
                    <button class="board-button" type="button" onclick="writeNotice('${sessionScope.member.userId}', '${page}');">
                        글등록
                    </button>
                </td>
             </tr>
