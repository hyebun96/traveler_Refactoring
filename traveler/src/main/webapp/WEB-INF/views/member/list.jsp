...
<div class="member">
    ...
    <form name="searchForm" action="<%=cp%>/member/list.do" method="post">
        <div style="text-align: right;">
            ...
            <button style="vertical-align: bottom; height: 23px; width: 90px; background: #eee; border: 1px solid #777;"
                    onclick="searchList()">검색
            </button>
            <button type="button"
                    style="vertical-align: bottom; height: 23px; width: 90px; background: #eee; border: 1px solid #777;"
                    onclick="javascript:location.href='<%=cp%>/member/list.do';">새로고침
            </button>
            <br>
        </div>
    </form>
