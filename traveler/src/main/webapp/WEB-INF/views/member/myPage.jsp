...
<head>
    ...
    <link rel="stylesheet" href="<%=cp%>/resource/css/member_mypage.css" type="text/css">
...
<div class="main">
    <div class="signup">
        <h1>${title}<img class="profile" src="<%=cp%>/resource/img/${dto.imageFilename}.png"/>
        </h1>
    </div>
        ...
        <form name="memberForm" class="memberForm" action="javascript:send();" method="post" enctype="multipart/form-data">
            ...
            <p>
                ...
                <input type="text" name="tel" value="${dto.tel1} - ${dto.tel2} - ${dto.tel3}" required="required"
                       maxlength="11" pattern="[0-9]+" placeholder="tel" readonly="readonly" class="input-box"/>

                <input type="hidden" name="tel1" value="${dto.tel1}" required="required" maxlength="11" pattern="[0-9]+"
                       placeholder="tel" class="tel" readonly="readonly">
            ...
            <p>
                <span>&nbsp;&nbsp;e-mail&nbsp;&nbsp;&nbsp;</span>
                <input class="email input-box" type="text" name="email1" value="${dto.email1} @ ${dto.email2}" required="required"
