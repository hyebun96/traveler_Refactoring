...
<head>
	...
	<script type="text/javascript" src="<%=cp%>/resources/js/travel.js"></script>
</head>
<body>
	<div class="header">
	...
	<div class="travel">
		<div class="weather">
			<img alt="" src="<%=cp%>/resources/img/weather/${weatherDTO.weather}">
			<p class="location">
				${type} weather
						...
						<span type="button" onclick="location.href='<%=cp%>/travel/like.do?num=${dto.num}&type=${type}'">
							<c:choose>
								<c:when test="${dto.likeNum > 0}">
									<img class="ico_like" alt="" src="<%=cp%>/resources/img/like.png">
								</c:when>
								<c:otherwise>
									<img class="ico_like" alt="" src="<%=cp%>/resources/img/unlike.png">
								</c:otherwise>
							</c:choose>
						</span>
					</span>
