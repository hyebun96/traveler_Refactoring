    ...
    <form name="travelForm" method="post" enctype="multipart/form-data">
        ...
        <div class="content-box2">
            ...
            <select name="type">
                ...
                <option value="Seoul" ${dto.type == "ㄴeoul" ? "selected='selected'" : ""}>서울</option>
                <option value="Gangwon-do" ${dto.type == "Gangwon-do" ? "selected='selected'" : ""}>강원</option>
                <option value="Chungcheongbuk-do" ${dto.type == "Chungcheongbuk-do" ? "selected='selected'" : ""}>충북
                </option>
                <option value="Gwangju" ${dto.type == "Gwangju" ? "selected='selected'" : ""}>광주</option>
                <option value="Gyeongsangbuk-do" ${dto.type == "Gyeongsangbuk-do" ? "selected='selected'" : ""}>경북
                </option>
